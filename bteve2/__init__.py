...
Panel = namedtuple('Panel', ['display_res','hcycle','hoffset','hsync0','hsync1','vcycle','voffset','vsync0','vsync1','swizzle','pclk_pol','cspread','dither','pclk_freq','so_mode','lvdstx_ch'])
